...
Route::set('user', '<action>(/<id>)', array('action' => 'create|login|logout'))
        ->defaults(array(
            'controller' => 'user',
    ));

Route::set('profile', '<action>(<id>)', array('action' => 'uid'))
    ->defaults(array(
    'controller' => 'profile',
    'action'=>'index',
));
...
$lang = Cookie::get('lang', 'ua');
if(!in_array($lang, array('ua', 'en')))
{
