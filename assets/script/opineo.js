	...
	$.fn.opineo = function( url, options ) {  
		...
		return this.each(function() {
			...
			var settings = {
				...
				show_votes_counter	 : false,     // whether to show votes counter or not
				...
				animation_speed  : 'Super',  // Animation speed is given in milliseconds; higher values indicate slower animations, not faster ones. 
				...
				view             : 'compact',     // set "mini" for without bars, "compact" for overall rating with single bar and "detailed" for detailed view with multiple bars. 
				
				unfilled_star_image  : '../../assets/images/img-full-star-grey.png', // path for the unfilled star image
				filled_star_image    : '../../assets/images/img-full-star.png',      // path for the filled star image
				//half_filled_star : 'images/img-full-star-half.png', // path for the half filled star image
				
				star_1_text      : "Жахливо",       // first star tool tip
				star_2_text      : "Може бути", // second star tool tip
				star_3_text      : "Непогано",     // third star tool tip
				star_4_text      : "Чудово",       // fourth star tool tip
				star_5_text      : "Супер!",       // fifth star tool tip
